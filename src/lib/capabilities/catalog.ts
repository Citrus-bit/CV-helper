...
const seeds: Record<CapabilityId, CatalogSeed> = {
  ...
  "resume.score": { name: "简历评分", description: "按六维标准生成可解释质量分。", dataScopes: ["resume_ast", "evidence_graph"] },
  "resume.suggest": { name: "简历建议", description: "生成受事实证据约束的分块修改建议。", dataScopes: ["resume_ast", "evidence_graph"] },
  "resume.atsAudit": { name: "ATS 审计", description: "检查机器读取和内容结构风险。", dataScopes: ["resume_ast", "source_blocks"] },
  "jd.parse": { name: "岗位解析", description: "把岗位描述拆解为可解释要求。", dataScopes: ["job_description"] },
  "job.match": { name: "岗位匹配", description: "将岗位要求映射到简历证据。", dataScopes: ["job_description", "evidence_graph"] },
  "job.riskDetect": { name: "岗位风险", description: "识别岗位描述中的招聘风险信号。", dataScopes: ["job_description"] },
  "copy.rewrite.zh": { name: "中文改写", description: "在不增加事实的前提下改善中文表达。", dataScopes: ["resume_ast"] },
  "copy.rewrite.en": { name: "英文改写", description: "在不增加事实的前提下改善英文表达。", dataScopes: ["resume_ast"] },
  ...
  "interview.plan": { name: "面试规划", description: "生成有时长和追问约束的训练计划。", dataScopes: ["anonymous_metadata"] },
  ...
  "answer.evaluate": { name: "回答评估", description: "按五维标准评估面试回答。", dataScopes: ["interview_content", "evidence_graph"] },
  "answer.coach": { name: "回答教练", description: "提供基于原回答的具体改进动作。", dataScopes: ["interview_content", "evidence_graph"] },
